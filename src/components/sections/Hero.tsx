...
// Load MeetPepFlow client-only — it is an overlay that never needs SSR
    ...
    <>
      ...
      <div className="relative flex-1 flex flex-col max-w-7xl mx-auto w-full px-5 md:px-8 lg:px-12">
        ...
        <div className="flex-1 flex flex-col lg:flex-row items-center pt-28 pb-12 gap-12 lg:gap-8 xl:gap-16">
          {/* Text column */}
          <motion.div
            className="flex-1 flex flex-col items-start lg:items-start"
          ...
          >
            ...
            <motion.h1
              variants={fadeInUp}
              className="text-[clamp(2.75rem,6vw,5.5rem)] font-bold leading-[1.04] tracking-tightest text-foreground text-balance mb-7"
            >
              {t("headline")
                .split("\n")
                .map((line, i) => (
            ...
            <motion.p
              variants={fadeInUp}
              className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-[460px] text-pretty mb-10"
            >
              {t("subheading")}
            </motion.p>
          ...
          <motion.div
            ...
            className="relative w-full lg:w-auto flex-shrink-0 flex items-center justify-center h-[520px] lg:h-auto lg:flex-1 lg:max-w-[420px]"
          >
            <PepVisual />
          </motion.div>
        </div>
