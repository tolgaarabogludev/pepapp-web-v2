      ...
      <div className="relative rounded-3xl border border-border/60 bg-card shadow-xl overflow-hidden">
        ...
        <div className="px-5 py-4 border-t border-border/50">
          <div className="flex items-center gap-3 bg-muted/50 rounded-full px-4 py-2.5">
            <span className="text-sm text-muted-foreground/50 flex-1">Bir şey sor...</span>
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="text-4xl md:text-5xl font-bold tracking-tightest text-foreground text-balance mb-6 leading-[1.06]">
              {t("heading")
                .split("\n")
                .map((line, i) => (
